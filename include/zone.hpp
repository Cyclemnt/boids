...
public : 
    ...
    std::vector<Boid*> getNearBoids(Interaction interaction, Boid* boid, std::vector<Boid*> boids, Boid* predator, std::vector<Boid*> predators, int envWidth, int envHeight);
    ...
    bool angleWithinInstinct(const vPose& boidPose, const vPose& dangerPose);
